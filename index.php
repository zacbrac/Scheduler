...
<body>
    ...
    <form action="view_schedule.php" method="POST">
        ...
        <input type="number" name="totalWeeks" placeholder="20"><br/>

        <label for="totalHours">Total Number of Hours: </label>
        <input type="number" name="totalHours" placeholder="200">
        <br><br>
        ...
        <input type="number" name="design" placeholder="20"><br/>

        <label for="development">Development Percentage: </label>
        <input type="number" name="development" placeholder="50"><br/>

        <label for="research">Research/Training Percentage: </label>
        <input type="number" name="research" placeholder="15"><br/>

        <label for="qa">QA Percentage: </label>
        <input type="number" name="qa" placeholder="15"><br/><br>
